...
type GetMessageHistoryRequest struct {
	...
	BeforeTime    *timestamp.Timestamp   `protobuf:"bytes,4,opt,name=before_time,json=beforeTime,proto3" json:"before_time,omitempty"`       // 获取此时间之前的消息（可选）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_chat_chat_proto_rawDesc = "" +
	...
	"\x0eGetUnreadCount\x12\x1f.api.chat.GetUnreadCountRequest\x1a .api.chat.GetUnreadCountResponseB\x15Z\x13gochat/api/api/chatb\x06proto3"
...
var file_api_chat_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_chat_chat_proto_goTypes = []any{
	...
	nil,                               // 14: api.chat.GetUnreadCountResponse.UnreadByUserEntry
...
var file_api_chat_chat_proto_depIdxs = []int32{
	...
	15, // 2: api.chat.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	15, // 3: api.chat.ChatMessage.updated_at:type_name -> google.protobuf.Timestamp
	...
	15, // 6: api.chat.GetMessageHistoryRequest.before_time:type_name -> google.protobuf.Timestamp
	...
	15, // 9: api.chat.UserInfo.last_seen:type_name -> google.protobuf.Timestamp
	14, // 10: api.chat.GetUnreadCountResponse.unread_by_user:type_name -> api.chat.GetUnreadCountResponse.UnreadByUserEntry
	...
	8,  // 16: api.chat.ChatService.SearchUser:output_type -> api.chat.SearchUserResponse
	4,  // 17: api.chat.ChatService.SendMessage:output_type -> api.chat.SendMessageResponse
	6,  // 18: api.chat.ChatService.GetMessageHistory:output_type -> api.chat.GetMessageHistoryResponse
	11, // 19: api.chat.ChatService.MarkMessageRead:output_type -> api.chat.MarkMessageReadResponse
	13, // 20: api.chat.ChatService.GetUnreadCount:output_type -> api.chat.GetUnreadCountResponse
